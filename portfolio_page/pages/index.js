      ...
      <div className={classes.container}>
        ...
        <div className={classes.banner_wrapper}>
          <div className={classes.left_txt}>
            ...
            <p className={classes.description}>
              ...
              deevloper to build your websites and grow your business Let’s
              shake hands with me.
            </p>
          ...
          <div className={classes.right_txt}>
            ...
            <p className={classes.txt2} >Explore resume</p>
          </div>
        </div>
            ...
            <div className={classes.divs}>
              <div className={classes.lft_section}>
                ...
                <div className={classes.inner_txt1}>
                  <p className={classes.txt1}>Fast and effectively working website</p>
                  <p className={classes.txt2}>Donec metuse, vulputate at sapiens sit amet, auctor iaculis lorem. In the hendrerit nisi.</p>
                </div>
              </div>
        ...
        <div className={classes.get_touch}>
          ...
          <div className={classes.txt_wrap}>
            ...
            <p className={classes.light}>Ready to make something creative?
              Let's get on a call.</p>
            <button className={classes.touch_btn}>Get in touch</button>
          </div>
        </div>
        <Footer/>
        <p className={classes.copyright}>Copyright © 2022 by Gulhayo Arabova. All Rights Reserved.</p>
      </div>
    </div>
  );
}
